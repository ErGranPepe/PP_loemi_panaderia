...
<a href="#" className="flex-shrink-0 flex items-center space-x-2 mr-auto">
  <img
    ...
    className="h-10 sm:h-12 md:h-16 lg:h-20 w-auto object-contain transition-transform duration-300 hover:scale-105 z-10 relative"
  />
</a>
          </div>
          <div className="hidden md:flex items-center space-x-4">
            ...
            <a
              ...
              className="flex items-center space-x-1 sm:space-x-2 bg-green-600 text-white px-3 sm:px-4 py-2 rounded-lg hover:bg-green-700 transition-colors text-sm sm:text-base"
            >
              ...
              <span className="hidden sm:inline">Hacer Encargo</span>
